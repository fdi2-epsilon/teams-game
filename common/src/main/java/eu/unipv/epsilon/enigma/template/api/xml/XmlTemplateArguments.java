...
public class XmlTemplateArguments implements TemplateArguments {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(XmlTemplateArguments.class);
    ...
    private Extractor getExtractor(List<String> tree) {
        ...
        if (tree.isEmpty() || "".equals(tree.get(0)))
            return new RootExtractor(documentElement);
